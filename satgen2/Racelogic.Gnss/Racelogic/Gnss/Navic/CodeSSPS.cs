...
namespace Racelogic.Gnss.Navic
{
	public static class CodeSSPS
	{
		...
		static CodeSSPS()
		{
			...
			g2Seeds = new uint[14][]
			{
				new uint[10] { 0u, 0u, 1u, 1u, 1u, 0u, 1u, 1u, 1u, 1u },
				new uint[10] { 0u, 1u, 0u, 1u, 1u, 1u, 1u, 1u, 0u, 1u },
				new uint[10] { 1u, 0u, 0u, 0u, 1u, 1u, 0u, 0u, 0u, 1u },
				new uint[10] { 0u, 0u, 1u, 0u, 1u, 0u, 1u, 0u, 1u, 1u },
				new uint[10] { 1u, 0u, 1u, 0u, 0u, 1u, 0u, 0u, 0u, 1u },
				new uint[10] { 0u, 1u, 0u, 0u, 1u, 0u, 1u, 1u, 0u, 0u },
				new uint[10] { 0u, 0u, 1u, 0u, 0u, 0u, 1u, 1u, 1u, 0u },
				new uint[10] { 0u, 1u, 0u, 0u, 1u, 0u, 0u, 1u, 1u, 0u },
				new uint[10] { 1u, 1u, 0u, 0u, 0u, 0u, 1u, 1u, 1u, 0u },
				new uint[10] { 1u, 0u, 1u, 0u, 1u, 1u, 1u, 1u, 1u, 0u },
				new uint[10] { 1u, 1u, 1u, 0u, 0u, 1u, 0u, 0u, 0u, 1u },
				new uint[10] { 1u, 1u, 0u, 1u, 1u, 0u, 1u, 0u, 0u, 1u },
				new uint[10] { 0u, 1u, 0u, 1u, 0u, 0u, 0u, 1u, 0u, 1u },
				new uint[10] { 0u, 1u, 0u, 0u, 0u, 0u, 1u, 1u, 0u, 1u }
			};
