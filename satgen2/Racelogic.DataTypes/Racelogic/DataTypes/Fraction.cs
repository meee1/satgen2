...
namespace Racelogic.DataTypes
{
	...
	public readonly struct Fraction : IComparable<Fraction>
	{
		...
		{
			int num3 = first.Numerator * second.Denominator + second.Numerator * first.Denominator;
			int num2 = first.Denominator * second.Denominator;
			return new Fraction(num3, num2);
		}
		...
		public static Fraction operator *(in Fraction first, in Fraction second)
		{
			int num3 = first.Numerator * second.Numerator;
			int num2 = first.Denominator * second.Denominator;
			return new Fraction(num3, num2);
		}
		...
		public static Fraction operator /(in Fraction first, in Fraction second)
		{
			int num3 = first.Numerator * second.Denominator;
		...
		{
			return (5993773 + numerator.GetHashCode()) * 9973 + denominator.GetHashCode();
		}
