...
namespace Racelogic.Gnss.SatGen.BeiDou
{
	internal sealed class NavigationDataB1ID1 : NavigationDataB1I
	{
		...
		{
			int num8 = base.Interval.Start.BeiDouSecondOfWeek / 6;
			int num2 = num8 * 6;
			...
			for (int i = 0; i < num3; i++)
			{
				...
				case 1:
				{
					...
					uint value5 = 0u;
					satelliteIndex = 5;
					byte[] second16 = NavigationData.Dec2Bin(in value5, in satelliteIndex);
					value5 = 0u;
					satelliteIndex = 4;
					byte[] second17 = NavigationData.Dec2Bin(in value5, in satelliteIndex);
					AddWord(list, enumerable.Append(element).Concat(second16).Concat(second17));
					...
					AddWord(list, first2.Concat(source30.Take(9)));
					IEnumerable<byte> second2 = NavigationData.ZeroBits.Take(10);
					IEnumerable<byte> source2 = NavigationData.ZeroBits.Take(10);
					AddWord(list, source30.Skip(9).Take(8).Concat(second2)
					...
					AddWord(list, source2.Skip(4).Take(6).Concat(second3)
						.Concat(second4));
					...
					AddWord(list, first3.Concat(second5).Concat(source3.Take(6)));
					value4 = NavigationDataB1I.betaParameters[1] * 6.103515625E-05;
					satelliteIndex = 8;
					byte[] second6 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
					value4 = NavigationDataB1I.betaParameters[2] * 1.52587890625E-05;
					satelliteIndex = 8;
					byte[] second7 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
					...
					AddWord(list, source3.Skip(6).Take(2).Concat(second6)
						.Concat(second7)
						.Concat(source4.Take(4)));
					value4 = satellite.A2 * 4.0;
					satelliteIndex = 11;
					byte[] second8 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
					value4 = satellite.A0 * 8589934592.0;
					satelliteIndex = 24;
					byte[] source5 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
					AddWord(list, source4.Skip(4).Take(4).Concat(second8)
						.Concat(source5.Take(7)));
					value4 = satellite.A1 * 1125899906842624.0;
					satelliteIndex = 22;
					byte[] source6 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
					AddWord(list, source5.Skip(7).Take(17).Concat(source6.Take(5)));
					value5 = 1u;
					satelliteIndex = 5;
					byte[] second9 = NavigationData.Dec2Bin(in value5, in satelliteIndex);
					AddWord(list, source6.Skip(5).Take(17).Concat(second9));
					break;
				}
				case 2:
				{
					...
					AddWord(list, enumerable.Concat(source7.Take(10)));
					value4 = satellite.Cuc * 2147483648.0;
					satelliteIndex = 18;
					byte[] source8 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
					AddWord(list, source7.Skip(10).Take(6).Concat(source8.Take(16)));
					value4 = satellite.MeanAnomaly * rad2Semi * 2147483648.0;
					satelliteIndex = 32;
					byte[] source9 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
					AddWord(list, source8.Skip(16).Take(2).Concat(source9.Take(20)));
					value4 = satellite.Eccentricity * 8589934592.0;
					satelliteIndex = 32;
					byte[] source10 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
					AddWord(list, source9.Skip(20).Take(12).Concat(source10.Take(10)));
					AddWord(list, source10.Skip(10).Take(22));
				...
				case 3:
				{
					...
					AddWord(list, source18.Skip(7).Take(11).Concat(source19.Take(11)));
					value4 = satellite.Cis * 2147483648.0;
					satelliteIndex = 18;
					byte[] source20 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
					AddWord(list, source19.Skip(11).Take(13).Concat(source20.Take(9)));
					...
					AddWord(list, source20.Skip(9).Take(9).Concat(source21.Take(13)));
					...
					AddWord(list, source21.Skip(13).Take(1).Concat(source22.Take(21)));
					value4 = satellite.ArgumentOfPerigee * rad2Semi * 2147483648.0;
					satelliteIndex = 32;
					byte[] source24 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
					AddWord(list, source22.Skip(21).Take(11).Concat(source24.Take(11)));
					AddWord(list, source24.Skip(11).Take(21).Concat(NavigationData.ZeroBits.Take(1)));
					break;
				}
				case 4:
				{
				...
				case 5:
				{
					...
					else if ((long)value2 == 8)
					{
						...
						int bitCount = 8;
						byte[] second10 = NavigationData.Dec2Bin(in satelliteIndex, in bitCount);
						...
						AddWord(list, satelliteHealthBits24.Concat(second10).Concat(source12.Take(5)));
						AddWord(list, source12.Skip(5).Take(3).Concat(NavigationData.ZeroAndOneBits.Take(19)));
					...
					else if ((long)value2 == 9)
					{
						...
						AddWord(list, NavigationData.ZeroBits.Take(6).Concat(second11).Concat(source23.Take(2)));
						value4 = satellite.A0Gal * 10.0;
						satelliteIndex = 14;
						byte[] source25 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
						AddWord(list, source23.Skip(2).Take(14).Concat(source25.Take(8)));
						value4 = satellite.A1Gal * 10.0;
						satelliteIndex = 16;
						byte[] second12 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
						AddWord(list, source25.Skip(8).Take(6).Concat(second12));
						...
						AddWord(list, first.Concat(source26.Take(8)));
						AddWord(list, source26.Skip(8).Take(8).Concat(NavigationData.ZeroAndOneBits.Take(14)));
					...
					else if ((long)value2 == 10)
					{
						...
						satelliteIndex = 8;
						byte[] source27 = NavigationData.Dec2Bin(in currentLeapSecond, in satelliteIndex);
						AddWord(list, enumerable.Concat(NavigationData.ZeroBits.Take(1)).Concat(array).Concat(source27.Take(2)));
						satelliteIndex = 8;
						byte[] second13 = NavigationData.Dec2Bin(in nextLeapSecond, in satelliteIndex);
						satelliteIndex = 8;
						byte[] second14 = NavigationData.Dec2Bin(in nextLeapSecondWeek, in satelliteIndex);
						AddWord(list, source27.Skip(2).Take(6).Concat(second13)
							.Concat(second14));
						double value4 = satellite.A0UTC * 1073741824.0;
						satelliteIndex = 32;
						byte[] source28 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
						AddWord(list, source28.Take(22));
						value4 = satellite.A1UTC * 1125899906842624.0;
						satelliteIndex = 24;
						byte[] source29 = NavigationData.Dec2Bin(in value4, in satelliteIndex);
						AddWord(list, source28.Skip(22).Take(10).Concat(source29.Take(12)));
						satelliteIndex = 8;
						byte[] second15 = NavigationData.Dec2Bin(in nextLeapSecondDay, in satelliteIndex);
						AddWord(list, source29.Skip(12).Take(12).Concat(second15)
