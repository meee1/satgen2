...
{
	internal sealed class BufferedGenerator : Generator
	{
		...
		unsafe static BufferedGenerator()
		{
		...
		public unsafe BufferedGenerator(in Memory<byte> buffer, ModulationBank modulationBank, GeneratorParams parameters, SimulationParams simulationParameters): base(in buffer, parameters)
		{
			...
			if (signals.Any())
			{
				...
				{
					ModulationType[] source = signalParameters.Keys.Where((ModulationType m) => bufferedGenerator.signalParameters[m].Any()).ToArray();
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							double num6 = signalParams.ModulationPointer[num5];
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							NormalizeCycles(ref cycles);
							double num7 = signalParams.ModulationPointer[num6];
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
							num4 -= item * num7;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							int num5 = (int)Interpolate(in signalParams.ChipIndexInterpolatorCoefficients[num2], in offset);
							NormalizeCycles(ref cycles);
							double num6 = (double)signalParams.ModulationPointer[num5] * signalParams.SignalLevel;
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
							num3 -= item * num6;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							int num6 = (int)Interpolate(in signalParams.ChipIndexInterpolatorCoefficients[num3], in offset);
							NormalizeCycles(ref cycles);
							double num7 = (double)signalParams.ModulationPointer[num6] * signalParams.SignalLevel;
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
							num4 -= item * num7;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < inPhaseParameters.Length; j++)
						{
							...
							NormalizeCycles(ref cycles);
							double num7 = signalParams.ModulationPointer[num5];
							double num8 = signalParams2.ModulationPointer[num6];
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
							num3 -= item * num7;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < inPhaseParameters.Length; j++)
						{
							...
							NormalizeCycles(ref cycles);
							double num8 = signalParams.ModulationPointer[num6];
							double num9 = signalParams2.ModulationPointer[num7];
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
							num4 -= item * num8;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < inPhaseParameters.Length; j++)
						{
							...
							int num6 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num2], in offset);
							NormalizeCycles(ref cycles);
							double num7 = (double)signalParams.ModulationPointer[num5] * signalParams.SignalLevel;
							double num8 = (double)signalParams2.ModulationPointer[num6] * signalParams2.SignalLevel;
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
							num3 -= item * num7;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < inPhaseParameters.Length; j++)
						{
							...
							int num7 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num3], in offset);
							NormalizeCycles(ref cycles);
							double num8 = (double)signalParams.ModulationPointer[num6] * signalParams.SignalLevel;
							double num9 = (double)signalParams2.ModulationPointer[num7] * signalParams2.SignalLevel;
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
							num4 -= item * num8;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < inPhaseParameters.Length; j++)
						{
							...
							NormalizeCycles(ref cycles);
							double num6 = signalParams.ModulationPointer[num5];
							double num7 = signalParams2.ModulationPointer[num5];
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
							num3 -= item * num6;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < inPhaseParameters.Length; j++)
						{
							...
							NormalizeCycles(ref cycles);
							double num6 = (double)signalParams.ModulationPointer[num5] * signalParams.SignalLevel;
							double num7 = (double)signalParams2.ModulationPointer[num5] * signalParams2.SignalLevel;
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
							num3 -= item * num6;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							double num8 = signalParams2.ModulationPointer[num7];
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							NormalizeCycles(ref cycles2);
							double num9 = signalParams2.ModulationPointer[num8];
							(double Sin, double Cos) tuple2 = SinCos(in cycles2);
							double item3 = tuple2.Sin;
							double item4 = tuple2.Cos;
							num5 += item3 * num9;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							int num7 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num2], in offset);
							NormalizeCycles(ref cycles2);
							double num8 = (double)signalParams2.ModulationPointer[num7] * signalParams2.SignalLevel;
							(double Sin, double Cos) tuple2 = SinCos(in cycles2);
							double item3 = tuple2.Sin;
							double item4 = tuple2.Cos;
							num4 += item3 * num8;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							int num8 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num3], in offset);
							NormalizeCycles(ref cycles2);
							double num9 = (double)signalParams2.ModulationPointer[num8] * signalParams2.SignalLevel;
							(double Sin, double Cos) tuple2 = SinCos(in cycles2);
							double item3 = tuple2.Sin;
							double item4 = tuple2.Cos;
							num5 += item3 * num9;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < phaseAccumulators.Length; j++)
						{
							...
							{
								int num7 = (int)Interpolate(in signalParams.ChipIndexInterpolatorCoefficients[num2], in offset);
								num5 = signalParams.ModulationPointer[num7];
							}
							if (!signalParams2.IsEmpty)
							{
								int num8 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num2], in offset);
								num6 = signalParams2.ModulationPointer[num8];
							}
							int num9 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num2], in offset);
							num5 += (double)signalParams3.ModulationPointer[num9];
							NormalizeCycles(ref cycles);
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < phaseAccumulators.Length; j++)
						{
							...
							if (!signalParams.IsEmpty)
							{
								int num8 = (int)Interpolate(in signalParams.ChipIndexInterpolatorCoefficients[num3], in offset);
								num6 = signalParams.ModulationPointer[num8];
							}
							if (!signalParams2.IsEmpty)
							{
								int num9 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num3], in offset);
								num7 = signalParams2.ModulationPointer[num9];
							}
							int num10 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num3], in offset);
							num6 += (double)signalParams3.ModulationPointer[num10];
							NormalizeCycles(ref cycles);
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < phaseAccumulators.Length; j++)
						{
							...
							{
								int num7 = (int)Interpolate(in signalParams.ChipIndexInterpolatorCoefficients[num2], in offset);
								num5 = (double)signalParams.ModulationPointer[num7] * signalParams.SignalLevel;
							}
							if (!signalParams2.IsEmpty)
							{
								int num8 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num2], in offset);
								num6 = (double)signalParams2.ModulationPointer[num8] * signalParams2.SignalLevel;
							}
							int num9 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num2], in offset);
							num5 += (double)signalParams3.ModulationPointer[num9] * signalParams3.SignalLevel;
							NormalizeCycles(ref cycles);
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < phaseAccumulators.Length; j++)
						{
							...
							{
								int num8 = (int)Interpolate(in signalParams.ChipIndexInterpolatorCoefficients[num3], in offset);
								num6 = (double)signalParams.ModulationPointer[num8] * signalParams.SignalLevel;
							}
							if (!signalParams2.IsEmpty)
							{
								int num9 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num3], in offset);
								num7 = (double)signalParams2.ModulationPointer[num9] * signalParams2.SignalLevel;
							}
							int num10 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num3], in offset);
							num6 += (double)signalParams3.ModulationPointer[num10] * signalParams3.SignalLevel;
							NormalizeCycles(ref cycles);
							(double Sin, double Cos) tuple = SinCos(in cycles);
							double item = tuple.Sin;
							double item2 = tuple.Cos;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							double num10 = signalParams3.ModulationPointer[num9];
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							int num10 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num3], in offset);
							NormalizeCycles(ref cycles3);
							double num11 = signalParams3.ModulationPointer[num10];
							(double Sin, double Cos) tuple3 = SinCos(in cycles3);
							double item5 = tuple3.Sin;
							double item6 = tuple3.Cos;
							num4 -= item5 * num11;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							int num9 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num2], in offset);
							NormalizeCycles(ref cycles3);
							double num10 = (double)signalParams3.ModulationPointer[num9] * signalParams3.SignalLevel;
							(double Sin, double Cos) tuple3 = SinCos(in cycles3);
							double item5 = tuple3.Sin;
							double item6 = tuple3.Cos;
							num3 -= item5 * num10;
				...
				.ForAll(delegate(int chunkIndex)
				{
					...
					for (int i = chunkOffsetSamples; i < chunkLimitSamples; i++)
					{
						...
						for (int j = 0; j < array.Length; j++)
						{
							...
							int num10 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num3], in offset);
							NormalizeCycles(ref cycles3);
							double num11 = (double)signalParams3.ModulationPointer[num10] * signalParams3.SignalLevel;
							(double Sin, double Cos) tuple3 = SinCos(in cycles3);
							double item5 = tuple3.Sin;
							double item6 = tuple3.Cos;
							num4 -= item5 * num11;
		...
		public unsafe double GetDualBpskRMS()
		{
			...
			for (int i = 0; i < 15000; i += 5)
			{
				...
				for (int j = 0; j < value.Length; j++)
				{
					...
					double cycles = Interpolate(in signalParams.PhaseAccumulatorCoefficients[num4], in offset);
					int num7 = (int)Interpolate(in signalParams.ChipIndexInterpolatorCoefficients[num4], in offset);
					int num8 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num4], in offset);
					NormalizeCycles(ref cycles);
					double num9 = (double)signalParams.ModulationPointer[num7] * signalParams.SignalLevel;
					double num2 = (double)signalParams2.ModulationPointer[num8] * signalParams2.SignalLevel;
					(double Sin, double Cos) tuple = SinCos(in cycles);
					double item = tuple.Sin;
					double item2 = tuple.Cos;
					num5 -= item * num9;
		...
		public unsafe double GetDualIndependentBpskRMS()
		{
			...
			for (int i = 0; i < 15000; i += 5)
			{
				...
				for (int j = 0; j < array.Length; j++)
				{
					...
					int num7 = (int)Interpolate(in signalParams.ChipIndexInterpolatorCoefficients[num4], in offset);
					NormalizeCycles(ref cycles);
					double num8 = (double)signalParams.ModulationPointer[num7] * signalParams.SignalLevel;
					(double Sin, double Cos) tuple = SinCos(in cycles);
					double item = tuple.Sin;
					double item2 = tuple.Cos;
					num5 -= item * num8;
				...
				{
					SignalParams signalParams2 = array[j];
					double cycles2 = Interpolate(in signalParams2.PhaseAccumulatorCoefficients[num4], in offset);
					int num9 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num4], in offset);
					NormalizeCycles(ref cycles2);
					double num2 = (double)signalParams2.ModulationPointer[num9] * signalParams2.SignalLevel;
					(double Sin, double Cos) tuple2 = SinCos(in cycles2);
					double item3 = tuple2.Sin;
					double item4 = tuple2.Cos;
					num6 += item3 * num2;
		...
		public unsafe double GetSinBocBpskRMS()
		{
			...
			for (int i = 0; i < 15000; i += 5)
			{
				double num11 = (double)i * samplingPeriod;
				int num5 = (int)(num11 * trajectorySampleRate) + firstObservableOffset;
				double offset = num11 - timePositionsPointer[num5];
				double num6;
				double num7;
				if (noiseSamples.IsEmpty)
				{
				...
				{
					double cycles = Interpolate(in array2[j][num5], in offset);
					SignalParams signalParams = value[j];
					SignalParams signalParams2 = value2[j];
					SignalParams signalParams3 = array[j];
					double num8 = 0.0;
					...
					if (!signalParams.IsEmpty)
					{
						int num10 = (int)Interpolate(in signalParams.ChipIndexInterpolatorCoefficients[num5], in offset);
						num8 = (double)signalParams.ModulationPointer[num10] * signalParams.SignalLevel;
					}
					if (!signalParams2.IsEmpty)
					{
						int num2 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num5], in offset);
						num9 = (double)signalParams2.ModulationPointer[num2] * signalParams2.SignalLevel;
					}
					int num3 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num5], in offset);
					num8 += (double)signalParams3.ModulationPointer[num3] * signalParams3.SignalLevel;
					NormalizeCycles(ref cycles);
					(double Sin, double Cos) tuple = SinCos(in cycles);
					double item = tuple.Sin;
					double item2 = tuple.Cos;
				...
				num4 += num6 * num6 + num7 * num7;
			}
			return Math.Sqrt(num4 / 6000.0);
		}
		...
		public unsafe double GetSinBocDualIndependentBpskRMS()
		{
			...
			for (int i = 0; i < 15000; i += 5)
			{
				double num12 = (double)i * samplingPeriod;
				int num6 = (int)(num12 * trajectorySampleRate) + firstObservableOffset;
				double offset = num12 - timePositionsPointer[num6];
				double num7;
				double num8;
				if (noiseSamples.IsEmpty)
				{
				...
				{
					SignalParams signalParams = array[j];
					double cycles = Interpolate(in signalParams.PhaseAccumulatorCoefficients[num6], in offset);
					int num9 = (int)Interpolate(in signalParams.ChipIndexInterpolatorCoefficients[num6], in offset);
					NormalizeCycles(ref cycles);
					double num10 = (double)signalParams.ModulationPointer[num9] * signalParams.SignalLevel;
					(double Sin, double Cos) tuple = SinCos(in cycles);
					double item = tuple.Sin;
					double item2 = tuple.Cos;
					num7 -= item * num10;
				...
				{
					SignalParams signalParams2 = array[j];
					double cycles2 = Interpolate(in signalParams2.PhaseAccumulatorCoefficients[num6], in offset);
					int num11 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num6], in offset);
					NormalizeCycles(ref cycles2);
					double num2 = (double)signalParams2.ModulationPointer[num11] * signalParams2.SignalLevel;
					(double Sin, double Cos) tuple2 = SinCos(in cycles2);
					double item3 = tuple2.Sin;
					double item4 = tuple2.Cos;
					num8 += item3 * num2;
				...
				{
					SignalParams signalParams3 = array[j];
					double cycles3 = Interpolate(in signalParams3.PhaseAccumulatorCoefficients[num6], in offset);
					int num3 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num6], in offset);
					NormalizeCycles(ref cycles3);
					double num4 = (double)signalParams3.ModulationPointer[num3] * signalParams3.SignalLevel;
					(double Sin, double Cos) tuple3 = SinCos(in cycles3);
					double item5 = tuple3.Sin;
					double item6 = tuple3.Cos;
					num7 -= item5 * num4;
		...
		public unsafe double GetMultiBandRMS()
		{
			...
			{
				double num11 = (double)i * samplingPeriod;
				int num4 = (int)(num11 * trajectorySampleRate) + firstObservableOffset;
				double offset = num11 - timePositionsPointer[num4];
				double num5 = 0.0;
				double num6 = 0.0;
				if (value != null)
				{
				...
				if (value2 != null)
				{
					...
					for (int j = 0; j < array.Length; j++)
					{
						...
						int num9 = (int)Interpolate(in signalParams2.ChipIndexInterpolatorCoefficients[num4], in offset);
						NormalizeCycles(ref cycles2);
						double num10 = (double)signalParams2.ModulationPointer[num9] * signalParams2.SignalLevel;
						(double Sin, double Cos) tuple2 = SinCos(in cycles2);
						double item3 = tuple2.Sin;
						double item4 = tuple2.Cos;
						num6 += item3 * num10;
				...
				if (value3 != null)
				{
					...
					{
						SignalParams signalParams3 = array[j];
						double cycles3 = Interpolate(in signalParams3.PhaseAccumulatorCoefficients[num4], in offset);
						int num2 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num4], in offset);
						NormalizeCycles(ref cycles3);
						double num3 = (double)signalParams3.ModulationPointer[num2] * signalParams3.SignalLevel;
						(double Sin, double Cos) tuple3 = SinCos(in cycles3);
						double item5 = tuple3.Sin;
						double item6 = tuple3.Cos;
						num5 -= item5 * num3;
		...
		private unsafe static (double Sin, double Cos) SinCos(in double cycles)
		{
			...
			double item = num4 * sinCosEntry.SinDiff + sinCosEntry.Sin;
			double item2 = num4 * sinCosEntry.CosDiff + sinCosEntry.Cos;
			return (item, item2);
		}
		...
		{
			double num = coefficient.C1 + offset * coefficient.C0;
			double num2 = coefficient.C2 + offset * num;
			return coefficient.C3 + offset * num2;
		}
