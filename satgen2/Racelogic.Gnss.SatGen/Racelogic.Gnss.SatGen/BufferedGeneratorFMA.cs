...
internal sealed class BufferedGeneratorFMA : Generator
{
	...
	public unsafe BufferedGeneratorFMA(in Memory<byte> buffer, ModulationBank modulationBank, GeneratorParams parameters, SimulationParams simulationParameters): base(buffer, parameters)
	{
	...
	public unsafe double GetInPhaseBpskRMS()
	{
		...
		for (int i = 0; i < 15000; i += 5)
		{
			...
			for (int j = 0; j < array.Length; j++)
			{
				...
				NormalizeCycles(ref cycles);
				double y = (double)signalParams.ModulationPointer[num7] * signalParams.SignalLevel;
				(double Sin, double Cos) tuple = SinCos(in cycles);
				double item = tuple.Sin;
				double item2 = tuple.Cos;
				num5 = Math.FusedMultiplyAdd(0.0 - item, y, num5);
				num6 = Math.FusedMultiplyAdd(item2, y, num6);
			}
	...
	public unsafe double GetDualBpskRMS()
	{
		...
		for (int i = 0; i < 15000; i += 5)
		{
			...
			for (int j = 0; j < value.Length; j++)
			{
				...
				NormalizeCycles(ref cycles);
				double y = (double)signalParams.ModulationPointer[num7] * signalParams.SignalLevel;
				double y2 = (double)signalParams2.ModulationPointer[num8] * signalParams2.SignalLevel;
				(double Sin, double Cos) tuple = SinCos(in cycles);
				double item = tuple.Sin;
				double item2 = tuple.Cos;
				num5 = Math.FusedMultiplyAdd(0.0 - item, y, num5);
				...
				num6 = Math.FusedMultiplyAdd(item, y2, num6);
			}
			num2 += num5 * num5 + num6 * num6;
		}
		return Math.Sqrt(num2 / 6000.0);
	...
	public unsafe double GetDualIndependentBpskRMS()
	{
		...
		for (int i = 0; i < 15000; i += 5)
		{
			...
			for (int j = 0; j < array.Length; j++)
			{
				...
				double item3 = tuple2.Sin;
				double item4 = tuple2.Cos;
				num6 = Math.FusedMultiplyAdd(item3, y2, num6);
				num5 = Math.FusedMultiplyAdd(item4, y2, num5);
			}
			num2 += num5 * num5 + num6 * num6;
		}
		return Math.Sqrt(num2 / 6000.0);
	...
	public unsafe double GetSinBocBpskRMS()
	{
		...
		for (int i = 0; i < 15000; i += 5)
		{
			...
			for (int j = 0; j < array2.Length; j++)
			{
				...
				int num10 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num4], in offset);
				num7 += (double)signalParams3.ModulationPointer[num10] * signalParams3.SignalLevel;
				NormalizeCycles(ref cycles);
				(double Sin, double Cos) tuple = SinCos(in cycles);
				double item = tuple.Sin;
				double item2 = tuple.Cos;
	...
	public unsafe double GetSinBocDualIndependentBpskRMS()
	{
		...
		for (int i = 0; i < 15000; i += 5)
		{
			...
			for (int j = 0; j < array.Length; j++)
			{
				...
				int num9 = (int)Interpolate(in signalParams3.ChipIndexInterpolatorCoefficients[num4], in offset);
				NormalizeCycles(ref cycles3);
				double y3 = (double)signalParams3.ModulationPointer[num9] * signalParams3.SignalLevel;
				(double Sin, double Cos) tuple3 = SinCos(in cycles3);
				double item5 = tuple3.Sin;
				double item6 = tuple3.Cos;
				num5 = Math.FusedMultiplyAdd(0.0 - item5, y3, num5);
				num6 = Math.FusedMultiplyAdd(item6, y3, num6);
			}
			num2 += num5 * num5 + num6 * num6;
		}
		return Math.Sqrt(num2 / 6000.0);
