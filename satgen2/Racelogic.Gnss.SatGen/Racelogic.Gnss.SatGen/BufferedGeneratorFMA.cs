...
internal sealed class BufferedGeneratorFMA : Generator
{
	...
	public unsafe BufferedGeneratorFMA(in Memory<byte> buffer, ModulationBank modulationBank, GeneratorParams parameters, SimulationParams simulationParameters)
	{
