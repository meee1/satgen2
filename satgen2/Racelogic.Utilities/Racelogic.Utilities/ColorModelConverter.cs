...
public class ColorModelConverter : BasePropertyChanged
{
	private Color color;
	...
	public ColorModelConverter(Color color)
	{
		alpha = color.A;
		red = (int)color.R;
		green = (int)color.G;
	...
	public ColorModelConverter(int r, int g, int b)
	{
		alpha = 255;
		red = rgbRange.Cap(r);
	...
	public ColorModelConverter(byte r, byte g, byte b)
	{
		alpha = 255;
		red = (int)r;
		green = (int)g;
	...
	public ColorModelConverter(double hue, double saturation, double lightness)
	{
		alpha = 255;
