...
public class Geoid : IDisposable
{
	...
	private const double OneOverC0 = 1.0 / 240.0;
	...
	private const double OneOverC0n = 1.0 / 372.0;
	...
	private const double OneOverC0s = 1.0 / 372.0;
	...
	public Geoid(GravitationalModel gravitationalModel, string egmFilePath)
	{
		...
		longRes = (double)pgmFileReader.Width * (1.0 / (2.0 * Math.PI));
